...
"apply|import": ['import', 0,
            [(_('s'), _('stat'), _('Output a diffstat for the input.  Does not actually apply.'), 0),
            (_('c'), _('check'), _('Check to see if it would apply.  Does not actually apply.'), 0),
            (_('v'), _('verbose'), _('Report progress to stdout'), 0)],
            _('Import a patch that has been exported by pyt'),
            _('pyt import [OPTIONS]... [PATCHES]...')],
"archive": ['archive', 0,
            [(_('f'), _('format'), _('specify zip or tar, default is tar'), 0),
            (_('c'), _('commit'), _('commit (commitid, symbolic reference) to create an archive for'), 0)],
...
"blame|annotate": ['blame', 0,
            [(_('l'), _('long'), _('show long rev'), 0),
            (_('n'), _('number'), _('show line numbers'), 0)],
            _('Show what revision and author edited a file line-by-line'),
            _('pyt blame [OPTIONS]... [COMMIT[:COMMIT]] [FILE]')],
"branch": ['branch', 1,
            [(_('d'), _('delete'), _('delete the named branch'), 0),
            (_('f'), _('force'), _('force creation or deletion'), 0),
            (_('m'), _('move'), _('rename the branch'), 0),
            (_('r'), _('remote'), _('list or delete remote-tracking branches'), 0),
            (_('v'), _('verbose'), _('show detailed information'), 0),
            (_('t'), _('track'), _('set up a tracking branch'), 0),
            (_('n'), _('no-track'), _('do not automatically track'), 0)],
...
"checkout|reset|co": ['checkout', 1,
            [(_('b'), _('branch'), _('Create a new branch starting at this commit'), 0),
            (_('f'), _('force'), _('Force operation'), 0)],
...
"cherry": ['cherry', 0,
            ...
            (_('n'), _('no-commit'), _('apply changes to working set but do not commit'), 0)],
            _('Apply the change introduced by an existing commit'),
            _('pyt cherry [OPTIONS]... <commit>')],
"clone": ['clone', 1,
            [(_('n'), _('no-checkout'), _('no checkout of HEAD is done after clone is complete'), 0),
            (_('b'), _('bare'), _('clone target dir is the git dir'), 0),
            (_('d'), _('depth'), _('create a shallow clone up to depth'), 0)],
            _('Clone a repository into a new directory'),
            _('pyt clone [OPTIONS]... <repository> [<directory>]')],
"config": ['config', 1,
            [(_('r'), _('repo-only'), _('option only applies to current repo'), 0),
            (_('d'), _('delete'), _('delete option'), 0),
            (_('a'), _('all'), _('show all configured options'), 0),
            (_('s'), _('set'), _('set a option'), 0),
            (_('i'), _('ignore'), _('ignore a pattern of files'), 0),
            (_('u'), _('unignore'), _('stop ignoring a pattern of files'), 0),
            (_(''), _('add'), _('add variable with the name even if it exists'), 0)],
