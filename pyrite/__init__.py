...
import configuration, extensions, options, ui, repository, help
from help import HelpError
...
def run():
    ...
    extensions.load(commands) #TODO:implement extension loading
    expandopts()
    try:
        command, args = options.parse(commands)
        if command:
