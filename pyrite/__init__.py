...
"diff": ['diff', 1,
            [('p', 'patch', _('generate a patch'), 0),
            ('s', 'stat', _('show a diffstat'), 0),
            ('c', 'color', _('show colored diff'), 0),
            ('t', 'template', _('use a formatted template'), 0),
            ('', 'style', _('use a predefined style'), 0),
            ('d', 'detect', _('detect renames and copies'), 0),
            ('', 'ignore-eol', _('ignore end of line whitespace differences'), 0),
